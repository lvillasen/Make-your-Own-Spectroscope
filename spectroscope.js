...
const  d_CD = parseFloat(document.getElementById("grating_d").value);
...
let array_minus1 =  new Array(Phase_R_CD.length).fill(-1);
...
let RedCDminus1_min = 90+grating_angle - Theta[MinAbsDifference(Phase_R_CD,array_minus1)];
let GreenCDminus1_min = 90+grating_angle - Theta[MinAbsDifference(Phase_G_CD,array_minus1)];
let BlueCDminus1_min = 90+grating_angle - Theta[MinAbsDifference(Phase_B_CD,array_minus1)];

console.log("Minus 1 "+RedCDminus1_min+" "+GreenCDminus1_min+" "+BlueCDminus1_min)
...
var CD_minus1 =   
  {
    ...
    mode: "lines",
    r: [10,10],
    theta: [RedCDminus1_min,BlueCDminus1_min],
    name: '-1st Order',
    line: {
      color: 'green'
    }
...
var data =[diffraction_grating,light,R_CD_1,G_CD_1,B_CD_1,R_CD_2,B_CD_2,R_CD_3,B_CD_3,R_CD_4,B_CD_4,CD_1,CD_2,CD_3,CD_4,R_CD_minus1,G_CD_minus1,B_CD_minus1,CD_minus1]
...
let array_minus1 =  new Array(Phase_R_DVD.length).fill(-1);
...
let RedDVDminus1_min = 90+grating_angle - Theta[MinAbsDifference(Phase_R_DVD,array_minus1)];
let GreenDVDminus1_min = 90+grating_angle - Theta[MinAbsDifference(Phase_G_DVD,array_minus1)];
let BlueDVDminus1_min = 90+grating_angle - Theta[MinAbsDifference(Phase_B_DVD,array_minus1)];
...
var DVD_minus1 =   
  {
    ...
    mode: "lines",
    r: [10,10],
    theta: [RedDVDminus1_min,BlueDVDminus1_min],
    name: '-1st Order',
    line: {
      color: 'black'
    }
...
var data =[diffraction_grating,light,R_DVD_1,G_DVD_1,B_DVD_1,R_DVD_2,B_DVD_2,R_DVD_3,B_DVD_3,DVD_1,DVD_2,DVD_3,R_DVD_minus1,G_DVD_minus1,B_DVD_minus1,DVD_minus1]
